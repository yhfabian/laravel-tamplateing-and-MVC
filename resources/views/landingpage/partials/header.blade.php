  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <h1 class="sitename">YohanesFabian</h1>
      </a>
            ...
            <div class="desktop-megamenu">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade" id="7525-tab-2" role="tabpanel" aria-labelledby="7525-tab-2-tab">
                  ...
                  <div class="featured-banner">
                    <div class="banner-content">
                      <img src="assets/frontend/img/misc/misc-12.webp" alt="Development Tools" class="banner-image">
                      <div class="banner-info">
                ...
                <div class="tab-pane fade" id="7525-tab-3" role="tabpanel" aria-labelledby="7525-tab-3-tab">
                  ...
                  <div class="featured-banner">
                    <div class="banner-content">
                      <img src="assets/frontend/img/misc/misc-5.webp" alt="Creative Suite" class="banner-image">
                      <div class="banner-info">
                        <h5>Creative Pro</h5>
